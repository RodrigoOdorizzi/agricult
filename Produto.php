          ...
          <div class="block">
            <div class="portfolio-menu">
              <div class="btn-group btn-group-toggle justify-content-center" data-toggle="buttons">
               ...
               <label class="col1 btn-sm btn btn-warning active ">

                  <input type="radio" name="shuffle-filter" value="all" checked="checked" />Todos
                </label>
                <label class="btn-sm btn btn-warning col1">
            ...
            <div class="row shuffle-wrapper" >
              <div class="col-md-4 portfolio-item shuffle-item" data-groups="[&quot;design&quot;]">
               ...
               <img src="images/portfolio/produto/prod_1.jpg" alt="">
                <div class="portfolio-hover">
                  <div class="portfolio-content">
                    <a href="images/portfolio/produto/prod_1.jpg" class="portfolio-popup"><i class="icon ion-search"></i></a>
                    <a class="h3" href="portfolio-single.html">Alface</a>
                    <p></p>
                  </div>
                </div>
              </div>
