...
>>>>>>> retiradocadastroconsumidor
    ...
    <section class="service-arrow" >
        <div class="container-fluid" >
                ...
                <div class="col-md-12 bg-primary bg-primary-darker">
                    <div class="block">
                ...
                <div class="col-md-12 bg-primary bg-primary-dark ">
                    <div class="block" > 
		...
		<a href="Nota_fiscal.php" target="_blank" class="btn btn-main bnt-main-black">Anuncie aqui</a>
